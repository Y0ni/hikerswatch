...
public void onClickFinito(View view){
    finish();
}
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(currPoint).title("Ya te vi"));
        mMap.moveCamera((CameraUpdateFactory.newLatLng(currPoint)));
        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(currPoint, 12.0f));
